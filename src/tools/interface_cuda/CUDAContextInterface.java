...
public class CUDAContextInterface {
  ...
  public interface Iface {
    ...
    public List<String> getActivatedWordsNetwork(List<DecodingInputWordNetwork> inputWordsSequence, int idMainWordNetwork, String tokensSentence) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getActivatedWordsNetwork(List<DecodingInputWordNetwork> inputWordsSequence, int idMainWordNetwork, String tokensSentence, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<String> getActivatedWordsNetwork(List<DecodingInputWordNetwork> inputWordsSequence, int idMainWordNetwork, String tokensSentence) throws org.apache.thrift.TException
    {
      send_getActivatedWordsNetwork(inputWordsSequence, idMainWordNetwork, tokensSentence);
      return recv_getActivatedWordsNetwork();
    }

    public void send_getActivatedWordsNetwork(List<DecodingInputWordNetwork> inputWordsSequence, int idMainWordNetwork, String tokensSentence) throws org.apache.thrift.TException
    {
      ...
      args.setTokensSentence(tokensSentence);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getActivatedWordsNetwork(List<DecodingInputWordNetwork> inputWordsSequence, int idMainWordNetwork, String tokensSentence, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getActivatedWordsNetwork_call method_call = new getActivatedWordsNetwork_call(inputWordsSequence, idMainWordNetwork, tokensSentence, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getActivatedWordsNetwork_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private String tokensSentence;
      public getActivatedWordsNetwork_call(List<DecodingInputWordNetwork> inputWordsSequence, int idMainWordNetwork, String tokensSentence, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.inputWordsSequence = inputWordsSequence;
        this.idMainWordNetwork = idMainWordNetwork;
        this.tokensSentence = tokensSentence;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getActivatedWordsNetwork<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getActivatedWordsNetwork_args> {
      ...
      public getActivatedWordsNetwork_result getResult(I iface, getActivatedWordsNetwork_args args) throws org.apache.thrift.TException {
        getActivatedWordsNetwork_result result = new getActivatedWordsNetwork_result();
        result.success = iface.getActivatedWordsNetwork(args.inputWordsSequence, args.idMainWordNetwork, args.tokensSentence);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getActivatedWordsNetwork<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getActivatedWordsNetwork_args, List<String>> {
      ...
      public void start(I iface, getActivatedWordsNetwork_args args, org.apache.thrift.async.AsyncMethodCallback<List<String>> resultHandler) throws TException {
        iface.getActivatedWordsNetwork(args.inputWordsSequence, args.idMainWordNetwork, args.tokensSentence,resultHandler);
      }
    }
  ...
  public static class getActivatedWordsNetwork_args implements org.apache.thrift.TBase<getActivatedWordsNetwork_args, getActivatedWordsNetwork_args._Fields>, java.io.Serializable, Cloneable, Comparable<getActivatedWordsNetwork_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TOKENS_SENTENCE_FIELD_DESC = new org.apache.thrift.protocol.TField("tokensSentence", org.apache.thrift.protocol.TType.STRING, (short)3);
    ...
    static {
      ...
      tmpMap.put(_Fields.ID_MAIN_WORD_NETWORK, new org.apache.thrift.meta_data.FieldMetaData("idMainWordNetwork", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      tmpMap.put(_Fields.TOKENS_SENTENCE, new org.apache.thrift.meta_data.FieldMetaData("tokensSentence", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getActivatedWordsNetwork_args(getActivatedWordsNetwork_args other) {
      ...
      if (other.isSetTokensSentence()) {
        this.tokensSentence = other.tokensSentence;
      }
    }
    ...
    public String getTokensSentence() {
      return this.tokensSentence;
    }

    public getActivatedWordsNetwork_args setTokensSentence(String tokensSentence) {
      this.tokensSentence = tokensSentence;
      return this;
    }

    public void unsetTokensSentence() {
      this.tokensSentence = null;
    }

    /** Returns true if field tokensSentence is set (has been assigned a value) and false otherwise */
    public boolean isSetTokensSentence() {
      return this.tokensSentence != null;
    }

    public void setTokensSentenceIsSet(boolean value) {
      if (!value) {
        this.tokensSentence = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case TOKENS_SENTENCE:
        if (value == null) {
          unsetTokensSentence();
        } else {
          setTokensSentence((String)value);
        }
        break;
    ...
    public boolean equals(getActivatedWordsNetwork_args that) {
      ...
      boolean this_present_tokensSentence = true && this.isSetTokensSentence();
      boolean that_present_tokensSentence = true && that.isSetTokensSentence();
      if (this_present_tokensSentence || that_present_tokensSentence) {
        if (!(this_present_tokensSentence && that_present_tokensSentence))
          return false;
        if (!this.tokensSentence.equals(that.tokensSentence))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_tokensSentence = true && (isSetTokensSentence());
      list.add(present_tokensSentence);
      if (present_tokensSentence)
        list.add(tokensSentence);
    ...
    public int compareTo(getActivatedWordsNetwork_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetTokensSentence()).compareTo(other.isSetTokensSentence());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetTokensSentence()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.tokensSentence, other.tokensSentence);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("tokensSentence:");
      if (this.tokensSentence == null) {
        sb.append("null");
      } else {
        sb.append(this.tokensSentence);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getActivatedWordsNetwork_argsStandardScheme extends StandardScheme<getActivatedWordsNetwork_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getActivatedWordsNetwork_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 3: // TOKENS_SENTENCE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.tokensSentence = iprot.readString();
                struct.setTokensSentenceIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getActivatedWordsNetwork_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldEnd();
        if (struct.tokensSentence != null) {
          oprot.writeFieldBegin(TOKENS_SENTENCE_FIELD_DESC);
          oprot.writeString(struct.tokensSentence);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
